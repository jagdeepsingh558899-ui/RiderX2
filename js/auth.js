...
AUTH.waitForAuth = async function (
    ...
    AUTH.state.readyPromise =
        new Promise(function (resolve) {
            ...
            /*
             * Prevent a race where auth becomes ready between
             * the earlier check and addEventListener().
             */
...
AUTH.requireRole = async function (
    ...
    if (
        ...
        /*
         * Never use localStorage role for authorization.
         */
...
AUTH.updateProfile = async function (
    ...
    /*
     * Client cannot change security-sensitive authority fields.
     */
